...
- **Use precise, unambiguous language.** Prefer numbers to vague quantifiers.
  - "The drug seemed to help quite a few patients." →
    "The drug reduced symptoms in 68% (32/47) of patients."
- **Define a technical term at first use** ("brain-derived neurotrophic factor
...
- Avoid emotional/evaluative language ("disappointing", "concerning"); state the
  result.
- Acknowledge conflicting evidence and offer measured reasons for discrepancies.
- Mark speculation as speculation ("suggesting that apoptosis *may be* the
  mechanism").
...
- **State the research question and the contribution in one sentence each,
  early.** Don't make the reader infer what the work claims.
...
### Appropriate hedging vocabulary
suggests / indicates / implies (interpretation, not proof) · may / might / could
(possibility) · appears to / seems to (needs confirmation) · likely / probably /
possibly (degree of certainty).

---

## Sentence mechanics quick-reference
...
| among / between | among ≥3; between = 2 |
| continual / continuous | repeated / uninterrupted |
| fewer / less | countable / continuous |
| i.e. / e.g. | that is / for example |
| imply / infer | speaker implies; listener infers |
| that / which | restrictive / non-restrictive (which takes a comma) |
| significant | reserve for *statistical* significance, not "important" |
| data are | plural (datum is singular) |

Avoid informal language ("a lot of" → "many/substantial"; "got" → "obtained")
and vague quantifiers ("some/often/recently" → specify the number/frequency/time).
...
| Weak | Better | Why |
|---|---|---|
| "It was found that there was an increase in error under low-light conditions." | "Error rates rose under low-light conditions." | Removes dummy phrasing; states the finding directly. |
| "A number of considerations in relation to the implementation were responsible for the outcomes observed." | "Three implementation changes produced the outcomes." | Strong verb, fewer abstractions, clear actor and claim. |
| "The literature contains many discussions of motivation." | "Recent studies disagree on whether financial incentives increase persistence once prior achievement is controlled." | Turns background into a sharpened problem. |
